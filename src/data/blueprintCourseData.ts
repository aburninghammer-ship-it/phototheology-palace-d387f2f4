...
export const blueprintLessons: BlueprintLesson[] = [
  ...
  // Level 2: The Plan of Redemption
  {
    ...
    practicalApplication: "The sanctuary teaches you how salvation works: 1) You sin (everyone does). 2) You confess (daily service). 3) Christ's blood covers you (the Lamb). 4) Your life is reviewed (yearly service/judgment). 5) Sin is finally destroyed (scapegoat). Where are you in this process? Have you confessed your sins? Have you accepted Christ's sacrifice? Are you living ready for the judgment? Don't just know about the sanctuary - live the sanctuary experience daily.",
    crossReferences: [
