...
export const bibleStoryLibrary: BookStories[] = [
  ...
  // JUDGES
  {
    ...
    stories: [
      ...
      { id: "jdg-2", title: "Gideon's 300", reference: "Judges 6-7", summary: "God reduces Gideon's army to 300 men and defeats the Midianites with torches and trumpets.", characters: ["Gideon", "Midianites"], themes: ["Faith", "Weakness", "God's Power"], lessonLearned: "God's power is perfected in weakness." },
  ...
  // DANIEL
  {
    ...
    stories: [
      ...
      { id: "dan-6", title: "Daniel's Visions", reference: "Daniel 7-12", summary: "Daniel receives visions of future kingdoms, the Ancient of Days, and end times.", characters: ["Daniel", "Ancient of Days", "Son of Man"], themes: ["Prophecy", "End Times", "Sovereignty"], lessonLearned: "God's kingdom will triumph over all." }
    ]
  },
