              ...
              return (
                ...
                >
                  ...
                  {isConnected ? (
                    ...
                    <Button size="sm" variant="outline" onClick={goToProfile}>
                      Connect
                    </Button>
                  )}
                </div>
      ...
      <Card className="bg-gradient-to-r from-green-500/10 via-blue-500/5 to-purple-500/10 border-green-500/20">
        <CardContent className="p-4">
          <div className="flex items-center justify-between">
            ...
            <Button size="sm" variant="ghost" onClick={goToProfile}>
              Manage
            </Button>
          </div>
        </CardContent>
      ...
      <CardContent className="pt-2">
        <div className="flex items-center gap-4 mb-4">
          {platforms.map(platform => {
            const Icon = platform.icon;
            return (
              <div key={platform.name} className={`p-2 rounded-full ${platform.bg}`}>
                <Icon className={`h-5 w-5 ${platform.color}`} />
              </div>
            );
          })}
