...
const gameModes = [
  ...
  {
    id: 'team_vs_jeeves' as GameMode,
    icon: Users,
    title: 'Team vs Jeeves',
    description: 'Team up against AI together',
  ...
  },
  {
    ...
    icon: Users,
    title: 'Team vs Team',
    description: 'Teams collaborate and compete',
  ...
  },
  {
    ...
    icon: Zap,
    title: 'Dr. Jeeves vs Professor Jeeves',
