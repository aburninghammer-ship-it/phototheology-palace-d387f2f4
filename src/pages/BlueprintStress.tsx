        ...
        <div className="container mx-auto px-4 py-8 max-w-4xl">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2">Stress Principle</h3>
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        <div className="mb-8 text-center">
          <h1 className="text-4xl font-bold mb-4">
            The Sanctuary Blueprint for Stress Management
          </h1>
          <p className="text-xl text-muted-foreground mb-6">
            How the Six Articles Guide You from Overwhelm → Peace → Stability → Rest
          </p>
          ...
          <EnhancedSocialShare
            title="The Sanctuary Blueprint for Stress Management"
            content="God's divine stress-regulation system through the sanctuary pattern"
