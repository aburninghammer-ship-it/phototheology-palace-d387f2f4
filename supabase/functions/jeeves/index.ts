...
**Return this JSON format:**
{
  ...
  "explanation": "Write a clear, beginner-friendly explanation specifically for people NEW to Phototheology. Structure it in 4 well-crafted paragraphs:\n\n**Paragraph 1 - The Verse & Context (2-3 sentences):** Introduce the Bible verse and its immediate context. What's happening in this passage? Set the stage simply and clearly.\n\n**Paragraph 2 - What Are These Principles? (4-5 sentences):** Explain what Phototheology principles ARE in simple terms. Clarify that they're like 'shorthand codes' that help us see deeper patterns in Scripture - connecting prophecies, sanctuary symbols, and Christ-centered themes across the Bible. Then briefly define EACH principle used in this specific equation, explaining what it represents in plain language a newcomer can understand.\n\n**Paragraph 3 - How to Solve the Equation (3-4 sentences):** Show step-by-step how to approach solving this equation. Explain what the operators (+, →, =) mean and how to trace the logical flow from one principle to the next. Give a clear example of how one principle connects to or leads into another in this specific equation.\n\n**Paragraph 4 - The Big Picture (2-3 sentences):** Tie it all together. What profound truth about Christ, salvation, or God's plan does this equation reveal? How does connecting these principles deepen our understanding of Scripture?\n\nIMPORTANT: Write in a warm, encouraging, teaching tone. Use complete sentences, proper grammar, and clear paragraph breaks. Imagine you're explaining this to someone who has never heard of Phototheology before - be patient, thorough, and inspiring!"
}`;
